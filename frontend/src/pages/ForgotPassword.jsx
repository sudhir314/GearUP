...
import { Mail, Lock, KeyRound, ArrowRight, Loader, ShieldAlert, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        if (step === 1) {
            ...
            await apiClient.post('/auth/verify-forgot-otp', { email: formData.email, otp: formData.otp.trim() });
            ...
            await apiClient.post('/auth/reset-password', { email: formData.email, otp: formData.otp.trim(), password: formData.password });
